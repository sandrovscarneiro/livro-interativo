...
preload("res://assets/imagens/bateria.png"),
preload("res://assets/imagens/guitarra.png")
], [preload("res://assets/imagens/briga.png"),preload("res://assets/imagens/raiva.png")]];
...
func spawn_bolha():
		...
		add_child(bolha)
		var entrada = get_parent().get_node("TouchScreenButton3").get_rand()
